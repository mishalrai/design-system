...
?>
    <div class="md-side-menu">
        <a href="<?php get_home_url(); ?>" class="site-logo">
            ...
            <svg version="1.1" id="Capa_1" width="43" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                viewBox="0 0 480.164 480.164" style="enable-background:new 0 0 480.164 480.164;" xml:space="preserve">
                    <path style="fill: #fff;" d="M464.164,232.082c-3.141,0.102-6.352,1.938-7.594,5.027l-7.133,17.84l-17.719-64.973c-0.875-3.199-3.633-5.527-6.93-5.855
